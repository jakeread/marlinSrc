...
#define DUAL_X_CARRIAGE
  ...
  #define X2_MAX_POS 237.2    // set maximum to the distance between toolheads when both heads are homed // increment this up to move X2 lines left
...
// @section robosquare
/**
 * Assuminng your bed is more-square than your machine: if it is an aluminum bed cut 
 * on a laser it probably is. 
 * Uses inductive probe to look for Y and X edges of bed, to measure actual angle
 * between X and Y axes. 
 * Uses found angle to apply transform at incoming gcodes, such that squares print
 * as squares, circles as circles, etc.
 * MUST Run after a G29 bed level; else measurements from inductive probe will be wonky.
 * 
 * ********** USES G38 
 */
