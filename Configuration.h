...
#define STRING_CONFIG_H_AUTHOR "(openassemblies.com, Config for FDM4D Machine, Dual Extruder)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD  BOARD_RAMPS_FDM4MD // BOARD_RAMPS_13_EFB
#endif
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // RAMPS 1.4 w/ E3D V6
  #define  DEFAULT_Kp 24.84 //36.27
  #define  DEFAULT_Ki 2.69 //7.10
  #define  DEFAULT_Kd 57.39 //46.36
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 20.00
  #define  DEFAULT_bedKi 0.123
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 80, 329, 210, 210 } // X1&X2 1/16 - Y1&Y2 1/16 - Z 1/8 - E0&E1 1/8
  // X is doubled, should not be. bug in firmware due to DUAL_X_CARRIAGE ?
